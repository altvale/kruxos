...
For you and your personal projects.

- Full appliance — all capabilities, dashboard, vault, sandbox
- All model providers (Anthropic, OpenAI, Gemini, Local, …)
- All extension surfaces (packs, plugins, themes)
- Indefinite use, single operator · community support
...
The KruxOS appliance (gateway, dashboard, runtime, image) is governed by the [End User License Agreement](https://altvale.com/legal/kruxos-eula). The community-extensible directories — `packs/`, `plugins/`, `themes/`, and `docs/public/` — are licensed under [Apache 2.0](https://github.com/altvale/kruxos/blob/main/packs/LICENSE).

## Get started

Download a [release](https://github.com/altvale/kruxos/releases/latest)
or pull the [Docker image](https://hub.docker.com/r/altvale/kruxos) and
run the first-boot wizard. Full tier breakdown + FAQ at
[kruxos.com/pricing](https://kruxos.com/pricing).
